...
Provides a back-end for the https://developer.enonic.com/docs/cms/xp8/schemas/form-items/customselector[CustomSelector form item] when used in Content Studio.
