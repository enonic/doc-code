...
Provides a back-end for the https://developer.enonic.com/docs/cms/schemas/form-items/customselector[CustomSelector form item] when used in Content Studio.
