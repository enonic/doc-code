...
To wire a processor into the execution pipeline, declare it in the app's https://developer.enonic.com/docs/cms/xp8/sites#site_xml[site descriptor], and add the application to the site.
...
The order of execution is determined by the `order` value (as defined in the https://developer.enonic.com/docs/cms/xp8/sites#site_xml[site descriptor]) combined with the order of the application list within the site.
