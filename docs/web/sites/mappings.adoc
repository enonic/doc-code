...
NOTE: <<../apis#, Universal APIs>> mounted contextually (`+/_/<app>:<api>+`) cannot be remapped through site mappings — they are routed before the site service processes mappings. If you need custom behavior on such a URL, implement a custom Universal API instead.
