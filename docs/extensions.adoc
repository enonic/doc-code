...
See <<extensions/liveview#,Liveview>>, <<extensions/contextpanel#,Context panel>>, and <<extensions/menuitem#,Menu item>> for worked examples: the `contentstudio.liveview`, `contentstudio.contextpanel`, and `contentstudio.menuitem` interfaces published by Content Studio.
