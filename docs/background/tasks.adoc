...
NOTE: For fine-grained control which nodes should be capable to execute distributable tasks use https://developer.enonic.com/docs/platform/xp8/deployment/config#application[Application] filter config or local apps. Or disable execution of named tasks entirely on some nodes by https://developer.enonic.com/docs/platform/xp8/deployment/config#task[Task] config.
