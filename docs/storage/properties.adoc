...
Node permissions are also flattened into indexed `_permissions_*` system properties at write time. See <<permissions#querying_by_permission, Permissions — Querying by permission>> for the full list and usage.
