...
WARNING: Filters are deprecated and will be removed in future XP versions. Use <<querying#_filter, query filtering>> instead — see the <<legacy_filter_migration, mapping table below>> for how each filter type translates to the DSL.
