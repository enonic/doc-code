...
NOTE: This chapter assumes the conceptual model — permission types, principal resolution, and how permissions behave across branches — is already familiar. If not, see the https://developer.enonic.com/docs/xp/stable/storage[XP storage documentation] for the platform-level concepts.
