...
TypeScript types come from the `@enonic-types/lib-auditlog` package, installed at the version of XP your project builds against — see <<../tooling/typescript#, TypeScript>>.
