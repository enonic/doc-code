...
In this case you must explicitly execute the function in the <<lib-context#run, context>> of System Administrator role.
...
TypeScript types come from the `@enonic-types/lib-auth` package, installed at the version of XP your project builds against — see <<../fundamentals/typescript#, TypeScript>>.
