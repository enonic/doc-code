...
TypeScript types come from the `@enonic-types/lib-auth` package, installed at the version of XP your project builds against — see <<../tooling/typescript#, TypeScript>>.
...
Takes the `principalKey` (a <<../libraries/types#group-key, GroupKey>> or <<../libraries/types#role-key, RoleKey>>) of the group or role to add members to, and an array of `members` — the <<../libraries/types#user-key, UserKey>> or <<../libraries/types#group-key, GroupKey>> values to add.
...
*object* : (<<../libraries/types#group, `Group`>>) The created group.
...
*object* : (<<../libraries/types#role, `Role`>>) The created role.
...
*object* : (<<../libraries/types#user, `User`>>) The created user.
...
Takes the `principalKey` (a <<../libraries/types#principal-key, PrincipalKey>>) of the principal to delete.
...
|===
| Name | Type | Description
| type | <<../libraries/types#principal-type, PrincipalType>> | *Optional.* Principal type to look for, one of `'user'`, `'group'` or `'role'`. If not specified all principal types are included.
...
*object* : (<<find-principals-result, `FindPrincipalsResult`>>) The total number of hits, the number returned, and an array of the matching <<../libraries/types#user, `User`>> objects.
...
Takes the `principalKey` (a <<../libraries/types#group-key, GroupKey>> or <<../libraries/types#role-key, RoleKey>>) of the group or role to retrieve members for.

[.lead]
Returns

*object[]* : (<<../libraries/types#user, `User`>> | <<../libraries/types#group, `Group`>>)[] A list of users and groups that are members of the principal, or an empty array if none.
...
Takes the `principalKey` (a <<../libraries/types#user-key, UserKey>> or <<../libraries/types#group-key, GroupKey>>) of the user or group to retrieve memberships for, and an optional `transitive` boolean — retrieve transitive memberships. Considered `false` if not specified.

[.lead]
Returns

*object[]* : (<<../libraries/types#group, `Group`>> | <<../libraries/types#role, `Role`>>)[] A list of groups and roles that the specified principal is a member of.
...
Returns the principal with the specified key. The result is narrowed to <<../libraries/types#user, `User`>>, <<../libraries/types#group, `Group`>> or <<../libraries/types#role, `Role`>> when the key type makes the principal type unambiguous.

[.lead]
Parameters

Takes the `principalKey` (a <<../libraries/types#principal-key, PrincipalKey>>) of the principal to look for.

[.lead]
Returns

*object* : (<<../libraries/types#principal, `Principal`>>) The principal as an object, or `null` if it does not exist.
...
|===
| Name | Type | Description
| key | <<../libraries/types#user-key, UserKey>> | Principal key of the user.
...
*object* : (<<../libraries/types#user, `User`>>) The logged-in user, or `null` if not logged in. When `includeProfile` is `true`, the user also carries a `profile` property.
...
|===
| Name | Type | Description
| key | <<../libraries/types#group-key, GroupKey>> | Principal key of the group to modify.
| editor | function | Editor callback `+(group: Group) => Group+` that receives the current <<../libraries/types#group, `Group`>> and returns the modified group.
|===

[.lead]
Returns

*object* : (<<../libraries/types#group, `Group`>>) The updated group, or `null` if the group was not found.
...
|===
| Name | Type | Description
| key | <<../libraries/types#role-key, RoleKey>> | Principal key of the role to modify.
| editor | function | Editor callback `+(role: Role) => Role+` that receives the current <<../libraries/types#role, `Role`>> and returns the modified role.
|===

[.lead]
Returns

*object* : (<<../libraries/types#role, `Role`>>) The updated role, or `null` if the role was not found.
...
|===
| Name | Type | Description
| key | <<../libraries/types#user-key, UserKey>> | Principal key of the user to modify.
| editor | function | Editor callback `+(user: User) => User+` that receives the current <<../libraries/types#user, `User`>> and returns the modified user.
|===

[.lead]
Returns

*object* : (<<../libraries/types#user, `User`>>) The updated user, or `null` if the user was not found.
...
Takes the `principalKey` (a <<../libraries/types#group-key, GroupKey>> or <<../libraries/types#role-key, RoleKey>>) of the group or role to remove members from, and an array of `members` — the <<../libraries/types#user-key, UserKey>> or <<../libraries/types#group-key, GroupKey>> values to remove.
...
The core principal types — <<../libraries/types#user, `User`>>, <<../libraries/types#group, `Group`>>, <<../libraries/types#role, `Role`>>, <<../libraries/types#principal, `Principal`>>, and the key types <<../libraries/types#principal-key, `PrincipalKey`>>, <<../libraries/types#user-key, `UserKey`>>, <<../libraries/types#group-key, `GroupKey`>>, <<../libraries/types#role-key, `RoleKey`>> and <<../libraries/types#principal-type, `PrincipalType`>> — are shared across the libraries and defined on the <<../libraries/types#, Types>> page.
...
| user | <<../libraries/types#user, User>> | *Optional.* The authenticated user. Present when `authenticated` is `true`.
...
| hits | <<../libraries/types#principal, Principal>>[] | The matching principals. For `findUsers()` the hits are <<../libraries/types#user, `User`>> objects.
|===
...
|===
| Name | Type | Description
| principal | <<../libraries/types#principal-key, PrincipalKey>> | Principal the entry grants access to.
