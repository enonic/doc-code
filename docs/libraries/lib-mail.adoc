...
[NOTE]
====
You also need to configure your smtp-server before you can send out email. For details, see https://developer.enonic.com/docs/platform/stable/deployment/config#mail[the configuration page]
====
...
Returns the default _from_ email address configured in the https://developer.enonic.com/docs/platform/stable/deployment/config#mail[XP mail configuration].
