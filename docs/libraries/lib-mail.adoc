...
TypeScript types come from the `@enonic-types/lib-mail` package, installed at the version of XP your project builds against — see <<../tooling/typescript#, TypeScript>>.
...
| data | <<../libraries/types#byte-source, ByteSource>> | Attachment stream.
