...
`getSchema()` takes a single `params` object with these properties:
...
`listSchemas()` takes a single `params` object with these properties:
...
`updateSchema()` takes a single `params` object with these properties:
...
`deleteSchema()` takes a single `params` object with these properties:
...
`getComponent()` takes a single `params` object with these properties:
...
`listComponents()` takes a single `params` object with these properties:
...
`createComponent()` takes a single `params` object with these properties:
...
`updateComponent()` takes a single `params` object with these properties:
...
`deleteComponent()` takes a single `params` object with these properties:
...
`getStyles()` takes a single `params` object with these properties:
...
`createStyles()` takes a single `params` object with these properties:
...
`updateStyles()` takes a single `params` object with these properties:
...
`deleteStyles()` takes a single `params` object with these properties:
...
`getSite()` takes a single `params` object with these properties:
...
`updateSite()` takes a single `params` object with these properties:
