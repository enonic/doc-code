...
NOTE: This API uses standard framework functionality. Please read the <<../runtime/i18n#, framework localization docs>> before using this API.
...
TypeScript types come from the `@enonic-types/lib-i18n` package, installed at the version of XP your project builds against — see <<../tooling/typescript#, TypeScript>>.
