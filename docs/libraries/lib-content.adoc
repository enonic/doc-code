...
| page | object | *Optional.* Content <<../libraries/types#page-component, page>>.
...
| page | object | The <<../libraries/types#page-component, page>> configuration, including regions and components.
|===
...
| page | object | A JSON object describing the <<../libraries/types#page-component, page>> configuration including regions and components.
