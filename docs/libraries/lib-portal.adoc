...
| baseUrl | string | *Deprecated.* Generate the URL from this base instead of resolving one from the request.
|===
...
| baseUrl | string | *Deprecated.* Serve the media from this base URL. Configure `+media.defaultBaseUrl+` instead.
| params | object | *Optional.* Custom query parameters to append to the URL.
|===
