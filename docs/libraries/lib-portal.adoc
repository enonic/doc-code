...
The content follows the request's `contentPath`, so when a <<../web/filters#reroute, site mapping filter>> has re-routed rendering, this returns the content the request was re-routed to.
