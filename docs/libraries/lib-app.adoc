...
TypeScript types come from the `@enonic-types/lib-app` package, installed at the version of XP your project builds against — see <<../tooling/typescript#, TypeScript>>.
...
|===
| Name                      | Type       | Description
| data                      | <<../libraries/types#byte-source, ByteSource>> | Icon binary data, as a stream that can be read with `lib-io`
