...
image:unstable.svg[Unstable,opts=inline] Virtual applications belong to the <<lib-schema#, dynamic schema>> API, which is *not stable*. It may change, or be withdrawn, in a future release.
