...
`getDescriptor()` takes a single `params` object with these properties:
...
`createVirtualApplication()` takes a single `params` object with these properties:
...
`deleteVirtualApplication()` takes a single `params` object with these properties:
...
`getApplicationMode()` takes a single `params` object with these properties:
