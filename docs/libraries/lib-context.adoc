...
TypeScript types come from the `@enonic-types/lib-context` package, installed at the version of XP your project builds against — see <<../fundamentals/typescript#, TypeScript>>.
