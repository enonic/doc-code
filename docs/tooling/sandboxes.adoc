...
Start by downloading an https://developer.enonic.com/docs/platform/stable/deployment/distro[Enonic XP distribution file]. This is essentially the software version of the Enonic XP platform.
