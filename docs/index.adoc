= Enonic Application development
...
== Introduction
Enonic XP is a highly modular and customizable platform. Enonic apps may contain anything from <<cms#,content schemas>>, APIs, tasks, admin extensions, id providers, and webapps to modern websites.
