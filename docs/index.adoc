...
Define your content model as code with Enonic schemas.

== What is a schema?

A schema defines a deterministic data structure. A schema provides a 1:1 mapping between schema fields and the underlying document structure, making it easy to work with content, both in Content Studio, and programmatically via the API.

Schemas are namespaced, and enable teams to easily share and reuse content models across projects and organizations
