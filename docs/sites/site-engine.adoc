...
The site pipeline is executed as a subset of the <<runtime#common_request_pipeline,common pipeline>>:
...
The following Universal API's are always available on the site endpoint.
