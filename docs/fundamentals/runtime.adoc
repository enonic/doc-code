...
Compatibility:: An app built against any XP release runs unchanged on every patch and minor release within the same major version. For the changes needed when moving from XP 7 to XP 8, see <<../upgrade/xp7#, Upgrading from XP 7>>.
