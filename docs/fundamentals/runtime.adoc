...
* *HTTP routing* — the https://developer.enonic.com/docs/platform/xp8/portal[Portal] dispatches incoming requests to four services (`/api`, `/admin`, `/site`, `/webapp`); you provide the implementations.
