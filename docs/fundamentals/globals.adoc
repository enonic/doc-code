...
`app` is the only name installed on the JavaScript global object. Every other name on this page is *module-scoped*: XP wraps each module in a function and passes them in as arguments.
