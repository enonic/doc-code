...
The quickest way to start a TypeScript project — with types, `tsconfig`, and build already wired up — is the https://market.enonic.com/starters/typescript-starter[TypeScript Starter]. Scaffold a new project from it with the https://developer.enonic.com/docs/enonic-cli/stable[Enonic CLI]:

[source,sh]
----
enonic create -r starter-typescript com.example.myapp
----
