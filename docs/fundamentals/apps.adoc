...
The file format, location, and reload behavior are documented in the https://developer.enonic.com/docs/platform/stable/deployment/config[XP platform documentation].
